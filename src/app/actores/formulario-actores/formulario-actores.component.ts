...
import { fechaNoPuedeSerFutura, primerarLetraMayusculo } from '../../compartidos/componentes/funciones/validaciones';
...
export class FormularioActoresComponent implements OnInit {
  ...
  @Output()
  posteoFormulario = new EventEmitter<ActorCeacionDTO>();
  private formBuilder = inject(FormBuilder)

  form = this.formBuilder.group({
    nombre:['',{
      validators:[Validators.required,primerarLetraMayusculo()]
    }],
  ...
  guardarCambios(){
    ...
    const actor = this.form.value as ActorCeacionDTO
